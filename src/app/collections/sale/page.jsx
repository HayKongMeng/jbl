...
export default function Sale() {
    ...
    return (
        <>
        <Banner title="เครื่องเล่นแผ่นเสียง" subTitle="คุณภาพเสียงระดับพรีเมี่ยม มาพร้อม ไมโครโฟน ที่ออกแบบมาให้สามารถใช้ได้กับทั้ง iPhone และ Android" classBg="im__010"/>
