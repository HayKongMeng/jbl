            ...
            <div className="header">
                <div className="header__container">
                    ...
                    <div className="header__icons js-closes-menu">
                        <Link href="#none" className="header__icon js-show-search" onClick={openSearchModal}>
                        ...
                        <SearchModal     isOpen={isModalOpen} onClose={closeSearchModal} />
                        ...
                        <Link href="#none" className="header__icon" onClick={toggleCart} >
                            ...
                            <div className={`cart-sidebar ${isCartOpen ? "visible" : ""}`}>
                                <div className="cart-sidebar__header">
                                    <h2>ตะกร้าสินค้าของคุณ</h2>
                                    <button className="cart-sidebar__close" onClick={toggleCart}>
                                        <svg width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" fill="none" fill-rule="evenodd" stroke-linejoin="round" aria-hidden="true" focusable="false" role="presentation" className="icon"><path d="M5 19 19 5M5 5l14 14"></path></svg>
                                    </button>
                                </div>
